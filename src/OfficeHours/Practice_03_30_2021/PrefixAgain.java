 ...
 * (made of up of the first n characters) appears in the remaining part of the String.
 * Print true or false.
 * Assume that the String is not empty and that n is
 * in the range from 1 to str.length().
 *
 * Examples:
 *
 * input: abXYabc
