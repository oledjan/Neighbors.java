...
public class ArraysEquals {
    public static void main(String[] args) {
        ...
        System.out.println("nums1 == nums2 - " + Arrays.equals(nums1, nums2)); // !!! this one is checking value
        System.out.println(nums1 == nums2); // not checking value, same object in memory when is stored only in a memory
